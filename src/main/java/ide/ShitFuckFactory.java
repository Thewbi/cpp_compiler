 ...
 */
public class ShitFuckFactory<PS> implements IntFunction<Node> {

    private static final Insets DEFAULT_INSETS = new Insets(0.0, 5.0, 0.0, 5.0);

    private static final Paint DEFAULT_TEXT_FILL = Color.web("#666");
    //private static final Paint DEFAULT_TEXT_FILL = Color.web("#600");
    ...
    //private static final Background DEFAULT_BACKGROUND = new Background(new BackgroundFill(Color.web("#f00"), null, null));
    ...
    public static <PS> IntFunction<Node> get( GenericStyledArea<PS, ?, ?> area, IntFunction<String> format )
    {
        if ( area instanceof StyleClassedTextArea ) {
            ...
            return get( classArea, format, null, null );
        }
            ...
            return get( inlineArea, format, null, null  );
        }
    ...
    {
        return new ShitFuckFactory<>( area, format, isFolded, removeFoldStyle );
    }
