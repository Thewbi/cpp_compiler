 ...
 */
public class ClassSpecifierASTNode extends ASTNode {

    public ClassSpecifierType classSpecifierType;
    ...
    public void printRecursive(final StringBuilder stringBuilder, final int indent, final boolean addLineBreak) {
        ...
        stringBuilder.append("[ClassSpecifier] ");
        stringBuilder.append("type=").append(classSpecifierType).append(" ");
